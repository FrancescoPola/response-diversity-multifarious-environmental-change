...
```{r surface-sketch, echo = FALSE,  include=TRUE, fig.cap='Response surface and principle illustration', fig.align="center", fig.height=6, fig.width=6}
knitr::include_graphics(here("Revision/assets/illustration_of_directional_derivatives.png"))
```
...
```{r add-epp-fig, fig.cap='Nonlinear and additive dependence of a rate on two environmental variables. (a) The value of $E_1$ at which the rate is maximised is independent of the value of $E_2$. (b) The value of $E_2$ at which the rate is maximised is independent of the value of $E_1$.', fig.align="center", fig.height=3, fig.width=8}
...
```{r int-epp-fig, fig.cap='Nonlinear and non-additive dependence of a rate on two environmental variables. (a) The value of $E_1$ at which the rate is maximised depends on the value of $E_2$. (b) The value of $E_2$ at which the rate is maximised is independent of the value of $E_1$.', fig.align="center", fig.height=8, fig.width=10}
## Visualise the performance surface of a species
pc_figs <- Plot_performance_curves(expt[[1]])
...
```{r lowE1-opt-species, fig.cap='Performance curves for a species with maximum growth at **low** values of $E_1$. Without interacting environmental effects.', fig.align="center", fig.height=3, fig.width=8}
## Visualise the performance surface of a species
...
```{r highE1-opt-species, fig.cap=' Performance curves for a species with maximum growth at **high** values of $E_1$. Without interacting environmental effects.', fig.align="center", fig.height=3, fig.width=8}
## Visualise the performance surface of a species
...
```{r lowE2-opt-species, fig.cap='Performance curves for a species with maximum growth at **low** values of $E_2$. Without interacting environmental effects.', fig.align="center", fig.height=3, fig.width=8}
## Visualise the performance surface of a species
...
```{r highE2-opt-species, fig.cap='Performance curves for a species with maximum growth at **high** values of $E_2$. Without interacting environmental effects.', fig.align="center", fig.height=3, fig.width=8}
## Visualise the performance surface of a species
...
```{r lowE1-opt-species1, fig.cap='Performance curves for a species with maximum growth at **low** values of $E_1$. With interacting environmental effects.', fig.align="center", fig.height=3, fig.width=8}
## Visualise the performance surface of a species
this_one <- which(par_table$z1 == min(par_table$z1))
pc_figs <- Plot_performance_curves(species_pars$expt[[this_one]])
pc_figs[[1]] + pc_figs[[2]] + plot_annotation(tag_levels = 'a',
...
```{r highE1-opt-species2, fig.cap='Performance curves for a species with maximum growth at **high** values of $E_1$. With interacting environmental effects.', fig.align="center", fig.height=3, fig.width=8}
## Visualise the performance surface of a species
this_one <- which(par_table$z1 == max(par_table$z1))
pc_figs <- Plot_performance_curves(species_pars$expt[[this_one]])
pc_figs[[1]] + pc_figs[[2]] + plot_annotation(tag_levels = 'a',
...
```{r lowE2-opt-species2, fig.cap='Performance curves for a species with maximum growth at **low** values of $E_2$. With interacting environmental effects.', fig.align="center", fig.height=3, fig.width=8}
## Visualise the performance surface of a species
this_one <- which(par_table$z2 == min(par_table$z2))
pc_figs <- Plot_performance_curves(species_pars$expt[[this_one]])
pc_figs[[1]] + pc_figs[[2]] + plot_annotation(tag_levels = 'a',
...
```{r highE2-opt-species2, fig.cap='Performance curves for a species with maximum growth at **high** values of $E_2$. With interacting environmental effects.', fig.align="center", fig.height=3, fig.width=8}
## Visualise the performance surface of a species
this_one <- which(par_table$z2 == max(par_table$z2))
pc_figs <- Plot_performance_curves(species_pars$expt[[this_one]])
pc_figs[[1]] + pc_figs[[2]] + plot_annotation(tag_levels = 'a',
...
```{r gamtest-species1, fig.cap='Performance curves for a species *without* interacting environmental effects and with some noise in the rate.', fig.align="center", fig.height=3, fig.width=8}
## Visualise the performance surface of a species
...
```{r example-1, fig.cap='Performance curves for a species *without* interacting environmental effects and with some noise in the rate.', fig.align="center", fig.height=3, fig.width=8}
...
```{r example-2, fig.cap='Performance curves for a species *without* interacting environmental effects and with some noise in the rate.', fig.align="center", fig.height=3, fig.width=8}
...
```{r gamtest-species2, fig.cap='Performance curves for a species *with* interacting environmental effects and with some noise in the rate.', fig.align="center", fig.height=3, fig.width=8}
## Visualise the performance surface of a species
pc_figs <- Plot_performance_obs(species_pars$expt[[which_species]])
pc_figs[[1]] + pc_figs[[2]] + plot_annotation(tag_levels = 'a',
                              tag_prefix = '(',
...
```{r example-3, fig.cap='Performance curves for a species *with* interacting environmental effects and with some noise in the rate.', fig.align="center", fig.height=3, fig.width=8}
## gam with interaction
...
```{r example-4, fig.cap='Performance curves for a species *with* interacting environmental effects and with some noise in the rate.', fig.align="center", fig.height=3, fig.width=8}
## gam without interaction
...
```{r partialderiv-species1, fig.cap='Response surface of sp1. The two solid lines show at which level of E1 and E2 each partial derivative is going to be calculated (E1 = 300, E2 = 20).', fig.align="center", fig.height=4, fig.width=6}
...
```{r partialeffectE1-species1, fig.cap='Partial effect of E1 on the growth rate of sp 1 when E2 is held constant at E2 = 20.', fig.align="center", fig.height=4, fig.width=6}
...
```{r partialE1-species1, fig.cap='Partial derivative with respect to E1 when E2 is constant at 20.', fig.align="center", fig.height=4, fig.width=6}
# draw partial derivs
p3 <- pd_E1 |>
    draw() &
  geom_line(col = "#1f77b4")&
...
```{r partialderivE2-species1, fig.cap='Response surface of sp1. The two solid lines show at which level of E1 and E2 each partial derivative is going to be calculated.', fig.align="center", fig.height=4, fig.width=6}
...
```{r partialeffectE2-species1, fig.cap='Partial effect of E2 on the growth rate of sp 1 when E1 is held constant at E1 = 300.', fig.align="center", fig.height=4, fig.width=6}
...
```{r partialE2-species1, fig.cap='Partial derivative with respect to E1 when E2 is constant at 20.', fig.align="center", fig.height=4, fig.width=6}
...
```{r summary-species1, fig.cap='Summary plot sp1. (a) response surface of sp 1. (b) Partial effect of E1 on the growth rate of sp 1 when E2 is held constant at E2 = 20. (c) Partial derivative with respect to E1 when E2 is constant at 20. (d) Partial effect of E2 on the growth rate of sp 1 when E1 is held constant at E1 = 300. (e) Partial derivative with respect to E2 when E1 is constant at 300.', fig.align="center", fig.height=12, fig.width=20}
...
fig6 <- b_fig2 + labs(color = "Directional \n  Derivative") +
  geom_segment(data = dd1,
               ...
               size=3) +  scale_colour_gradient2(low = muted("blue"),
                         mid = "white",
                         high = muted("red"),
                         midpoint = 0)
...
```{r multiple-points-all-directions, fig.cap='Directional derivatives calculated in all possible direction for several points on the response surface of sp1. Clearly, the slope of the directional derivative depends on the direction (red positive, blue negative).', fig.align="center", fig.height=5, fig.width=8}
...
```{r all-points-all-directions, fig.cap='Directional derivatives calculated in all possible direction for a grid of points on the response surface of sp1. Clearly, the slope of the directional derivative depends on the direction (red positive, blue negative).', fig.align="center", fig.height=5, fig.width=8}
...
```{r RD-independent, fig.cap='Time series of E1 and E2 changing independently over time.', fig.align="center", fig.height=3, fig.width=8}
...
```{r RD-negative, fig.cap='Time series of E1 and E2 changing with negative correlation over time.', fig.align="center", fig.height=3, fig.width=8}
library(MASS)
...
```{r RD-positive, fig.cap='Time series of E1 and E2 changing with positive correlation over time.', fig.align="center", fig.height=3, fig.width=8}
library(MASS)
...
```{r RDpositiveplot, fig.cap=' Directional derivatives and response diversity with known trajectory of env change for community 1 and 2. E1 and E2 change with negative correlation over time.a and b: Species directional derivatives over time. c and d: Response diversity measured as similarity-based diversity metric. e and : Response diversity measured as divergence (sign sensitive). ', fig.align="center", fig.height=12, fig.width=12}
...
# library(chromote)
# 
#pagedown::chrome_print(here("Revision/Appendix1_principles-and-demos_v2.html"), output = "Appendix1_principle-and-demos.pdf")
```
